...
export interface ApiConfigOptionConfigOption extends Struct.SingleTypeSchema {
  collectionName: 'config_options';
  info: {
    description: '';
    displayName: 'ConfigOption';
    pluralName: 'config-options';
    singularName: 'config-option';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    draggables: Schema.Attribute.Component<'draggables.draggables', true> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::config-option.config-option'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    radioGroups: Schema.Attribute.Component<'radio-groups.radio-group', true>;
...
export interface ApiSizeSize extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    baseSize: Schema.Attribute.Decimal & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
